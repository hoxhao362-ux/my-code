...
class InvitationCode(Base):
    ...
    expire_time: Mapped[str | None] = mapped_column(Text, nullable=True, comment="过期时间（ISO字符串）")
...
class InvitationCodeUsage(Base):
    ...
    use_time: Mapped[str] = mapped_column(Text, nullable=False, comment="使用时间（ISO字符串）")
