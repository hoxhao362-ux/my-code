...
<template>
  <div class="step-container">
    ...
    <div class="form-group">
      <label class="form-label">Subject / Discipline <span class="required">*</span></label>
      <select v-model="store.formData.subject" class="form-select">
        <option value="" disabled>Select the primary subject</option>
    ...
    <div class="form-group">
      ...
      <p class="helper-text">Enter keywords separated by commas (e.g., COVID-19, Vaccine, mRNA)</p>
      <input
        type="text"
        v-model="store.formData.keywords"
        class="form-input"
        placeholder="Enter 3-5 keywords"
      >
